...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Управление меню • <?php echo"$row[title]";?></title>
		...
		echo "                    
                                <tbody>
                                    <tr>
										...
										<td>
                                                                <a href ='update-menu.php?id=$row[id]' class='btn btn-primary-edit'>Изменить</a>
                                                            </td>
										<td>
                                                                <a href ='del-menu.php?id=$row[id]' class='btn btn-primary-del'>Удалить</a>
                                                            </td>
                                    </tr>
                                </tbody>
                            ";
...
?>
							...
							<center><br><br>
	  <a href ="add-menu.php?id=1" class="btn btn-primary-add w-md">Добавить пункт</a>				
