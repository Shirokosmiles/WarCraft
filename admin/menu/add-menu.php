...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Добавить пункт в меню сайта • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Добавить пункт в меню сайта</h4>
                    </div>
...
if($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET["id"]))
{
    ...
    $sql = "SELECT * FROM menu WHERE id = '$userid'";
                        ...
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input class='form-control' type='text' name='name' value='' placeholder='Главная'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <div class='col-lg-6'>
                                <div class='mt-3 mt-lg-0'>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Путь к иконке</label>
                                        <input class='form-control' type='text' name='icon' value='../template/nighthold/images/icons/header/'>
                                    </div>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Стиль</label>
                                        <input class='form-control' type='text' name='class' value='menu__link'>
                                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["name"]) && isset($_POST["link"]) && isset($_POST["icon"]) && isset($_POST["class"])  && isset($_POST["idm"])  ) {
    ...
    $sql = "INSERT INTO menu  (`id`, `name`, `link`, `icon`, `class`) VALUES ('$idm', '$name', '$link', '$icon', '$class')";
    if($result = mysqli_query($conn, $sql)){
       echo "<center>Пункт успешно был добавлен! <br><br>
	  <a href ='javascript:history.go(-2)' class='btn btn-primary w-md update'>Вернуться назад</a>
	   ";
    } else{
        echo "Ошибка: " . mysqli_error($conn);
