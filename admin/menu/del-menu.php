...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Удаление пункта из меню сайта • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Удаление пункта из меню сайта</h4>
                    </div>
                        ...
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='hidden' class='form-control' type='text' name='name' value='$name'>
                                    </div>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'></label>
                                        <input type='hidden' class='form-control' type='text' name='link' value='$link'>
                                    </div>
                            ...
                            <div class='col-lg-6'>
                                <div class='mt-3 mt-lg-0'>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'></label>
                                        <input type='hidden' class='form-control' type='text' name='icon' value='$icon'>
                                    </div>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'></label>
                                        <input type='hidden' class='form-control' type='text' name='class' value='$class'>
                                    </div>
												...
												<center>Вы уверены что хотите удалить пункт '$name'? <br><br><div class='mt-4'>
...
elseif (isset($_POST["id"]) && isset($_POST["name"]) && isset($_POST["link"]) && isset($_POST["icon"]) && isset($_POST["class"])   ) {
    ...
    $sql = "DELETE FROM menu WHERE id='$userid'";
    if($result = mysqli_query($conn, $sql)){
       echo "<center>Пункт успешно был удалён! <br><br>
	  <a href ='javascript:history.go(-2)' class='btn btn-primary w-md update'>Вернуться назад</a>
	   ";
    } else{
        echo "Ошибка: " . mysqli_error($conn);
