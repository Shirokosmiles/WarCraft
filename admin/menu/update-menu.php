...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Редактирование меню сайта • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Настройка меню сайта</h4>
                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["name"]) && isset($_POST["link"]) && isset($_POST["icon"]) && isset($_POST["class"])   ) {
    ...
    $sql = "UPDATE menu SET name = '$name', link = '$link', icon = '$icon', class = '$class' WHERE id = '$userid'";
    if($result = mysqli_query($conn, $sql)){
