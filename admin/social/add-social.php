...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Добавить соц.сеть • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Добавить соц.сеть</h4>
                    </div>
...
if($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET["id"]))
{
    ...
    $sql = "SELECT * FROM social_link WHERE id = '$userid'";
                            ...
                            <div class='col-lg-6'>
                                <div class='mt-3 mt-lg-0'>
                                    <div class='mb-3'>
                                        ...
                                        <input class='form-control' type='text' name='class' value='soc__link _icon-'>
                                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["class"]) && isset($_POST["link"]) && isset($_POST["idm"])  ) {
    ...
    $sql = "INSERT INTO social_link  (`id`, `class`, `link`) VALUES ('$idm', '$class', '$link')";
    if($result = mysqli_query($conn, $sql)){
       echo "<center>Соц.сеть успешно была добавлена! <br><br>
	  <a href ='javascript:history.go(-2)' class='btn btn-primary w-md update'>Вернуться назад</a>
	   ";
    } else{
        echo "Ошибка: " . mysqli_error($conn);
