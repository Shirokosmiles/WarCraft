...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Социальные ссылки • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Социальные ссылки</h4>
		...
		echo "                    
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$row[class]</td>
										<td>
                                                                <a href ='update-social.php?id=$row[id]' class='btn btn-primary-edit'>Изменить</a>
                                                            </td>
										<td>
                                                                <a href ='del-social.php?id=$row[id]' class='btn btn-primary-del'>Удалить</a>
                                                            </td>
                                    </tr>
                                </tbody>
                            ";
...
?>
							...
							<center><br><br>
	  <a href ="add-social.php?id=1" class="btn btn-primary-add w-md">Добавить реалм</a>				
