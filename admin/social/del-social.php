...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Удаление пункта соц.сетей • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Удаление пункта соц.сетей</h4>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='hidden' class='form-control' type='text' name='link' value='$link'>
												...
												<center>Вы уверены что хотите удалить соц.сеть '$link'? <br><br><div class='mt-4'>
...
elseif (isset($_POST["id"]) && isset($_POST["link"])) {
    ...
    $sql = "DELETE FROM social_link WHERE id='$userid'";
    if($result = mysqli_query($conn, $sql)){
       echo "<center>Соц.сеть успешно была удален! <br><br>
	  <a href ='javascript:history.go(-2)' class='btn btn-primary w-md update'>Вернуться назад</a>
	   ";
    } else{
        echo "Ошибка: " . mysqli_error($conn);
