...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Редактирование соц.сетей • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Настройка соц.сетей</h4>
                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["link"]) && isset($_POST["class"])  ) {
    ...
    $sql = "UPDATE social_link SET link = '$link', class = '$class' WHERE id = '$userid'";
    if($result = mysqli_query($conn, $sql)){
