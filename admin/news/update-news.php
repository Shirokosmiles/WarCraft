...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Редактирование новостей сайта • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Настройка новостей сайта</h4>
                    </div>
                        ...
                        <div class='row'>
                            ...
                            <div class='col-lg-6'>
                                <div class='mt-3 mt-lg-0'>
                                    ...
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Дата публикации</label>
...
elseif (isset($_POST["id"]) && isset($_POST["text"]) && isset($_POST["link"]) && isset($_POST["images"]) && isset($_POST["date"])  ) {
    ...
    $sql = "UPDATE news SET text = '$text', link = '$link', images = '$images', date = '$date' WHERE id = '$userid'";
    if($result = mysqli_query($conn, $sql)){
