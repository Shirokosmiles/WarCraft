...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Управление новостями • <?php echo"$row[title]";?></title>
		...
		echo "                    
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$row[date]</td>
										<td>
                                                                <a href ='update-news.php?id=$row[id]' class='btn btn-primary-edit'>Изменить</a>
                                                            </td>
										<td>
                                                                <a href ='del-news.php?id=$row[id]' class='btn btn-primary-del'>Удалить</a>
                                                            </td>
                                    </tr>
                                </tbody>
                            ";
...
?>
							...
							<center><br><br>
	  <a href ="add-news.php?id=1" class="btn btn-primary-add w-md">Добавить новость</a>				
