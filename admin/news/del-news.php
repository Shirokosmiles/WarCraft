...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Удаление новости из сайта • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Удаление новости из сайта</h4>
                    </div>
                        ...
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='hidden' class='form-control' type='text' name='text' value='$text'>
                                    </div>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'></label>
                            ...
                            <div class='col-lg-6'>
                                <div class='mt-3 mt-lg-0'>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'></label>
                                        <input type='hidden' class='form-control' type='text' name='images' value='$images'>
                                    </div>
												...
												<center>Вы уверены что хотите удалить новость '$text'? <br><br><div class='mt-4'>
...
elseif (isset($_POST["id"]) && isset($_POST["text"]) && isset($_POST["link"]) && isset($_POST["images"]) ) {
    ...
    if($result = mysqli_query($conn, $sql)){
       echo "<center>Новость успешно была удалена! <br><br>
	  <a href ='javascript:history.go(-2)' class='btn btn-primary w-md update'>Вернуться назад</a>
	   ";
    } else{
        echo "Ошибка: " . mysqli_error($conn);
