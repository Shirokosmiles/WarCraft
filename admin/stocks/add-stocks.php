...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Добавить акцию • <?php echo"$row[title]";?></title>
...
if($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET["id"]))
{
    ...
    $sql = "SELECT * FROM stocks WHERE id = '$userid'";
                            ...
                            <div class='col-lg-6'>
                                <div>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input class='form-control' type='text' name='title' value='' placeholder='Подарки'>
                                    </div>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Описание</label>
                                        <input class='form-control' type='text' name='description' value='' placeholder='Подарки игрокам'>
                                    </div>
                            ...
                            <div class='col-lg-6'>
                                <div class='mt-3 mt-lg-0'>
                                    <div class='mb-3'>
                                        ...
                                        <input class='form-control' type='text' name='images' value='../template/nighthold/images/'>
                                    </div>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Ссылка</label>
                                        <input class='form-control' type='text' name='link' value='https://'>
                                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["title"]) && isset($_POST["link"]) && isset($_POST["images"]) && isset($_POST["description"])  && isset($_POST["idm"])  ) {
    ...
    $sql = "INSERT INTO stocks  (`id`, `title`, `link`, `images`, `description`) VALUES ('$idm', '$title', '$link', '$images', '$description')";
    if($result = mysqli_query($conn, $sql)){
       echo "<center>Акция успешно была добавлена! <br><br>
	  <a href ='javascript:history.go(-2)' class='btn btn-primary w-md update'>Вернуться назад</a>
	   ";
    } else{
        echo "Ошибка: " . mysqli_error($conn);
