...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Удаление акции • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Удаление акции</h4>
                    </div>
                            ...
                            <div class='col-lg-6'>
                                <div>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='hidden' class='form-control' type='text' name='title' value='$title'>
                                    </div>
												...
												<center>Вы уверены что хотите удалить акцию '$title'? <br><br><div class='mt-4'>
...
elseif (isset($_POST["id"]) && isset($_POST["title"])) {
    ...
    $sql = "DELETE FROM stocks WHERE id='$userid'";
    if($result = mysqli_query($conn, $sql)){
       echo "<center>Акция успешно была удален! <br><br>
	  <a href ='javascript:history.go(-2)' class='btn btn-primary w-md update'>Вернуться назад</a>
	   ";
    } else{
        echo "Ошибка: " . mysqli_error($conn);
