...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Редактирование акций • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Настройка акций</h4>
                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["title"]) && isset($_POST["description"]) && isset($_POST["images"]) && isset($_POST["link"])  ) {
    ...
    $sql = "UPDATE stocks SET title = '$title', description = '$description', images = '$images', link = '$link' WHERE id = '$userid'";
    if($result = mysqli_query($conn, $sql)){
