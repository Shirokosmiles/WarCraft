...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Акции • <?php echo"$row[title]";?></title>
		...
		echo "                    
                                <tbody>
                                    <tr>
										...
										<td>
                                                                <a href ='update-stocks.php?id=$row[id]' class='btn btn-primary-edit'>Изменить</a>
                                                            </td>
										<td>
                                                                <a href ='del-stocks.php?id=$row[id]' class='btn btn-primary-del'>Удалить</a>
                                                            </td>
                                    </tr>
                                </tbody>
                            ";
...
?>
							...
							<center><br><br>
	  <a href ="add-stocks.php?id=1" class="btn btn-primary-add w-md">Добавить акцию</a>				
