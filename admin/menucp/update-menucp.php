...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Управление бокового меню личного кабинета • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Редактирование бокового меню личного кабинета</h4>
                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["name"]) && isset($_POST["link"]) && isset($_POST["icon"])  ) {
    ...
    $sql = "UPDATE menu_cp SET name = '$name', link = '$link', icon = '$icon' WHERE id = '$userid'";
    if($result = mysqli_query($conn, $sql)){
