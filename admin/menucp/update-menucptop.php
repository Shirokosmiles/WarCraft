...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Редактирование меню личного кабинета • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Редактирование верхнего меню личного кабинета</h4>
                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["name"]) && isset($_POST["link"])) {
    ...
    $sql = "UPDATE menu_cp_top SET name = '$name', link = '$link' WHERE id = '$userid'";
    if($result = mysqli_query($conn, $sql)){
