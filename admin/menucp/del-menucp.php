...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Удаление бокового пункта из меню личного кабинета • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Удаление бокового пункта из меню личного кабинета</h4>
                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["name"]) && isset($_POST["link"]) ) {
    ...
    $sql = "DELETE FROM menu_cp WHERE id='$userid'";
    if($result = mysqli_query($conn, $sql)){
