...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Добавить боковой пункт в меню личного кабинета • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Добавить боковой пункт в меню личного кабинета</h4>
                    </div>
...
if($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET["id"]))
{
    ...
    $sql = "SELECT * FROM menu_cp WHERE id = '$userid'";
                        ...
                        <div class='row'>
                            ...
                            <div class='col-lg-6'>
                                <div class='mt-3 mt-lg-0'>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Название иконки</label>
                                        <input class='form-control' type='text' name='icon' value='' placeholder='home'>
                                    </div>
									<div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Ссылка</label>
                                        <input class='form-control' type='text' name='link' value='' placeholder='#'>
                                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["name"]) && isset($_POST["link"]) && isset($_POST["icon"])  && isset($_POST["idm"])  ) {
    ...
    $sql = "INSERT INTO menu_cp  (`id`, `name`, `link`, `icon`) VALUES ('$idm', '$name', '$link', '$icon')";
    if($result = mysqli_query($conn, $sql)){
