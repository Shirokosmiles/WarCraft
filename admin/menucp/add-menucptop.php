...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Добавить верхний пункт в меню личного кабинета • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Добавить верхний пункт в меню личного кабинета</h4>
                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["name"]) && isset($_POST["link"]) && isset($_POST["idm"])  ) {
    ...
    $sql = "INSERT INTO menu_cp_top  (`id`, `name`, `link`) VALUES ('$idm', '$name', '$link')";
    if($result = mysqli_query($conn, $sql)){
