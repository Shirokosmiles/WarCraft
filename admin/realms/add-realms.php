...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Добавить реалм • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Добавить реалм</h4>
                    </div>
                            ...
                            <div class='col-lg-6'>
                                <div>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input class='form-control' type='text' name='name' value='' placeholder='Укажите название мира'>
                                    </div>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Иконка</label>
                                        <input class='form-control' type='text' name='icon' value='template/nighthold/images/server/' >
                                    </div>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Описание</label>
                                        <input class='form-control' type='text' name='description' value='' placeholder='Укажите описание мира'>
                                    </div>
									<div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Профессии</label>
                                        <input class='form-control' type='text' name='proffesion' value='' placeholder='x1'>
                                    </div>
									<div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Репутация</label>
                                        <input class='form-control' type='text' name='rep' value='' placeholder='x1'>
                                    </div>
                            ...
                            <div class='col-lg-6'>
                                <div class='mt-3 mt-lg-0'>
                                    <div class='mb-3'>
                                        ...
                                        <input class='form-control' type='text' name='rate' value='' placeholder='x1'>
                                    </div>
                                    <div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Версия</label>
                                        <input class='form-control' type='text' name='version' value='lich'>
                                    </div>
									<div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Класс</label>
                                        <input class='form-control' type='text' name='class' value='' placeholder='Если это 1 реалм вписать active, если последующие не вписывать ничего!'>
                                    </div>
									<div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Золото</label>
                                        <input class='form-control' type='text' name='gold' value='' placeholder='x1'>
                                    </div>
									<div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Лут</label>
                                        <input class='form-control' type='text' name='loot' value='' placeholder='x1'>
                                    </div>
									<div class='mb-3'>
                                        <label for='example-text-input' class='form-label'>Хонор</label>
                                        <input class='form-control' type='text' name='honor' value='' placeholder='x1'>
                                    </div>
...
elseif (isset($_POST["id"]) && isset($_POST["name"]) && isset($_POST["rate"]) && isset($_POST["icon"]) && isset($_POST["description"]) && isset($_POST["proffesion"]) && isset($_POST["gold"]) && isset($_POST["rep"]) && isset($_POST["loot"]) && isset($_POST["honor"]) && isset($_POST["class"])  ) {
	...
	$sql = "INSERT INTO realms  (`id`, `name`, `rate`, `icon`, `version`, `description`, `proffesion`, `gold`, `rep`, `loot`, `honor`, `class`) VALUES ('$idm', '$name', '$rate', '$icon', '$version' ,  '$description', '$proffesion', '$gold', '$rep', '$loot', '$honor', '$class')";
    if($result = mysqli_query($conn, $sql)){
