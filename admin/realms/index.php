...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Управление реалмами • <?php echo"$row[title]";?></title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Управление реалмами</h4>
						<p class="card-title-desc">Страницы сайта</p>
                    </div>
		...
		echo "                    
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$row[rate]</td>
										<td>
                                                                <a href ='update-realms.php?id=$row[id]' class='btn btn-primary-edit'>Изменить</a>
                                                            </td>
										<td>
                                                                <a href ='del-realms.php?id=$row[id]' class='btn btn-primary-del'>Удалить</a>
                                                            </td>
                                    </tr>
                                </tbody>
                            ";
...
?>
							...
							<center><br><br>
	  <a href ="add-realms.php?id=1" class="btn btn-primary-add w-md">Добавить реалм</a>				
