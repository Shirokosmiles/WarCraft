                ...
                <div class="card card-bordered">
                    <div class="card-inner">
                        <div class="card-title-group">
                            <h5 class="card-title">
                                <span class="mr-2">Рейтинги PvP <span class="text-primary"></span></span>
                            </h5>
                        </div>
                    </div>
...
<div class="nk-tb-item">
								<div class="nk-tb-col"><span class="sub-text">1</span></div>
                                <div class="nk-tb-col"><span class="sub-text">Wzwesmia</span></div>
                                <div class="nk-tb-col tb-col-md"><span class="sub-text">80</span></div>
								<div class="nk-tb-col tb-col-md"><span class="sub-text">161</span></div>
                                <div class="nk-tb-col tb-col-md"><span class="sub-text">2829</span></div>
                                <div class="nk-tb-col tb-col-xl"><span class="sub-text">Рыцарь смерти</span></div>								
                                <div class="nk-tb-col tb-col-xl"><span class="sub-text">09.03.2022 00:19:10</span></div>
